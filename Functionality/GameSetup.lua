...
local DefaultResourceTable = import(ScenarioInfo.MapPath .. 'Tables/Genesis_of_the_Order_Survival_tables_DefaultResources.lua')
...
function TheRedOrTheBluePill()
    ...
    local EnemyArmyName = {
        "ARMY_ENEMY_AEON", "ARMY_ENEMY_SERAPHIM"}
...
function InitializeGame()
    ...
    PlayableArea.SetArea()
    Diplomacy.SetupDiplomacy(PlayerArmies)
